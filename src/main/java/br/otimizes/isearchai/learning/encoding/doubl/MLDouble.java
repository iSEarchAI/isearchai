...
public class MLDouble extends Number implements Comparable<Double>, Cloneable, MLElement {
     ...
     */
    public MLDouble(String s) throws NumberFormatException {
        value = parseDouble(s);
    }
    ...
    public int compareTo(Double anotherDouble) {
        return Double.compare(value, anotherDouble);
    }
